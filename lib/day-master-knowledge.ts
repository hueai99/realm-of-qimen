...
export const dayMasterKnowledge: Record<string, DayMasterKnowledge> = {
  ...
  Yi: {
    ...
    strengths: [
      ...
      { heading: "Notices how others feel", meaning: "may notice tone, timing, and how others are responding", everyday: "changing approach when a friend seems uncomfortable", descriptions: ["{name} may notice small changes in another person's tone or expression. If a friend seems uncomfortable, he or she may soften the words or approach the conversation differently.", "{name} may quickly sense when another person feels uneasy. He or she may then change how something is said or give the person more space.", "{name} may pay attention to how other people respond. A friend's expression or tone may be enough for him or her to realise that a gentler approach is needed."], support: "acknowledge this thoughtfulness, and remind him or her that personal feelings and needs matter too" },
  ...
  Ji: {
    ...
    strengths: [
      { heading: "Nurtures growth", meaning: "may naturally help others feel supported", everyday: "showing someone younger how to do something or tending carefully to a shared project", descriptions: ["{name} may be patient when helping someone learn or when working on something that needs steady care.", "{name} may enjoy showing a younger child what to do or looking after a shared project with care.", "{name} may help people feel supported by patiently showing them what to do."], support: "thank him or her for being thoughtful while also making room for personal needs" },
      { heading: "Remembers useful details", meaning: "may remember useful things learned earlier and bring them up when they matter", everyday: "recalling something from an earlier lesson that helps with a problem today", descriptions: ["{name} may remember something learned earlier and use it when a similar problem comes up.", "{name} may bring up a useful fact or idea at just the right moment.", "{name} may connect something learned before with a problem that needs solving today."], support: "encourage him or her to share what was remembered while making it clear that nobody needs to have every answer" },
      { heading: "Resourceful care", meaning: "can find practical ways to make things better", everyday: "quietly organising materials or noticing what someone needs", descriptions: ["{name} may notice practical things that could make a situation easier, such as organising materials or offering help.", "{name} may quietly spot what is needed and take a practical step to help.", "{name} may show care by organising what is needed or making a task easier for someone."], support: "notice the thought behind the help, not only the result" },
    ],
    softSpots: [
      { heading: "Own needs may come second", meaning: "may concentrate on helping others even when already tired", everyday: "agreeing to help when rest is needed", description: "{name} may keep helping others even when he or she is tired. He or she may agree to another request when rest would be more helpful.", support: "let him or her know it is okay to say no when time to rest is needed" },
      { heading: "Quick to notice tension", meaning: "may notice tension even when nobody speaks about it", everyday: "becoming quieter or more tense during uncertainty at home or school", description: "{name} may sense tension at home or school before anyone explains what is wrong. He or she may seem fine at first, then become quieter or more tense.", support: "explain what is happening in simple terms, offer reassurance, and leave room for questions later" },
    ],
