...
export const dayMasterKnowledge: Record<string, DayMasterKnowledge> = {
  ...
  Yi: {
    ...
    softSpots: [
      { heading: "May follow other people's choices", meaning: "may change a personal preference after seeing what others have chosen", everyday: "changing a choice after hearing what a friend wants", support: "ask for his or her choice before sharing what other people have chosen, so there is less pressure to match the group" },
