...
export type ReportPoint = { heading: string; body: string };
export type ChartData = { hour: string | null; day: string; month: string; year: string; day_master: string; strength: string; structure: string; profile_stars: string[] };
