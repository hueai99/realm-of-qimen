  ...
  return <main className="min-h-screen">
    ...
    <article className="mx-auto max-w-5xl px-6 pb-20 pt-8">
      ...
      {summary ? <div className="mt-12 space-y-12">
        ...
        <ReportFeedback reportId={report.id} childName={report.subject_name} />
        {emailToken && <EmailSummaryCard reportId={report.id} initialEmail={report.email} token={emailToken} />}
