...
Realm of Qimen — a Bazi destiny-reading web app where parents and working adults submit birth details, receive an AI-generated Bazi report, and can upgrade to a paid premium consult.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "302008928+hueai99@users.noreply.github.com"
  git config user.name "hueai99"
  ```
